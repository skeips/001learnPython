...
if ask_to_add == "y":
    coffee_types.extend(defined_menu)

# Prompt the user to enter coffee types until they say no or leave
# their input blank.
while True:
...
serial_numbers = list(range(len(coffee_types)))
...
if to_remove in range(len(coffee_types)):
    ...
    coffee_types.remove(coffee_types[to_remove])
